...
class LISA:
    def __init__(self, config):
        ...
        self.config.seg_token_idx = self.tokenizer("[SEG]", add_special_tokens=False).input_ids[0]
        ...
        self.model = LISAForCausalLM.from_pretrained(self.config.version, low_cpu_mem_usage=True, vision_tower=self.config.vision_tower, seg_token_idx=self.config.seg_token_idx, **kwargs)
